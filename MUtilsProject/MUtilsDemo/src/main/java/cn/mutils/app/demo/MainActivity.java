...
import cn.mutils.app.demo.net.PayDemoView;
...
import cn.mutils.app.demo.ui.UPPayDemoView;
...
public class MainActivity extends BasicActivity {
	...
	@OnClick({ R.id.ui_adapter, R.id.zip, R.id.conf_item, R.id.aes, R.id.fir, R.id.anim_task, R.id.media, R.id.net_task,
			...
			R.id.uppay, R.id.web_frame, R.id.intent_executor, R.id.umeng, R.id.surface_viewer, R.id.progress_icon ,R.id.channel})
